# Elephant — Prompt Reference Sheet

> **Version:** 1.0
> **Character:** Elephant (Preschool, 4-5 years)
...
|-----------|-------|
| Name | Elephant |
| Species | Cute elephant |
| Appearance | Light gray skin, large warm brown eyes, large floppy ears, long expressive trunk, short tail with small tuft, two small tusks visible when smiling, round soft features, gentle smile, long eyelashes, blue hair ribbon |
| Default Outfit | Blue overalls with pocket, white t-shirt underneath, blue sneakers |
| Style | Pixar-quality, Cocomelon-inspired, bright colorful nursery world, highly detailed, soft lighting, vibrant colors |
| Signature Feature | Large floppy ears (always expressive) |
...
|----------|-------------|---------|
| `{name}` | Character name | Elephant |
| `{species}` | Species description | Cute elephant |
| `{appearance}` | Physical appearance | Light gray skin, large warm brown eyes, ... |
| `{outfit}` | Outfit description | Blue overalls with pocket, white t-shirt |
| `{outfit_variant}` | Alternate outfit | Blue puffy coat with matching hat |
...
|---|------------|---------------|
| 1 | Neutral | Elephant, Cute elephant, light gray skin, large warm brown eyes, large floppy ears, long expressive trunk, short tail with small tuft, two small tusks visible when smiling, round soft features, gentle smile, long eyelashes, blue hair ribbon, wearing blue overalls with pocket, white t-shirt underneath, blue sneakers, neutral expression, portrait shot, Pixar-quality, Cocomelon-inspired, bright colorful nursery world, highly detailed, soft lighting, vibrant colors |
...
| # | Outfit | Description |
|---|--------|-------------|
| 1 | Daily Outfit | Blue overalls with pocket, white t-shirt underneath, blue sneakers (signature look) |
| 2 | Winter Coat | Blue puffy coat with matching hat and mittens |
| 3 | Rain Outfit | Blue raincoat with hood, matching boots |
| 4 | Swimsuit | Blue one-piece with ruffled trim |
| 5 | Pajamas | Blue PJs with elephant print, matching sleep mask |
| 6 | Birthday Outfit | Blue party dress with peanut pattern |
| 7 | Teacher Costume | Blue vest with pointer, glasses on trunk |
| 8 | Artist Costume | Blue beret, smock with paint stains |
| 9 | Musician Costume | Blue conductor outfit with baton |
| 10 | Sports Uniform | Blue athletic wear, matching headband |
| 11 | Halloween Costume | Blue elephant costume (she's already an elephant!) |
| 12 | Christmas Outfit | Blue and silver dress with snowflake pattern |
...
|-----|-----------|-------|
| Toddler (2-3) | toddler, smaller body, rounder features, oversized head, 2 years old | Smaller proportions, wobbly on big feet |
| Preschool (4-5) | preschool age, 4-5 years old | Current canonical design — gentle giant, excellent memory |
| Kindergarten (5-6) | kindergarten age, 5-6 years old, slightly taller | Taller, more coordinated, still sweet |
...
## Quality Checklist for Elephant

- [ ] Character is instantly recognizable as Elephant
- [ ] Large floppy ears are visible and expressive
- [ ] Brown eyes are warm and expressive
- [ ] Trunk is positioned appropriately for the expression
- [ ] Skin is light gray (not dark gray or blue)
