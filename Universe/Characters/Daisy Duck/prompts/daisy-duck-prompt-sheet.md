# Daisy Duck — Prompt Reference Sheet

> **Version:** 1.0
> **Character:** Daisy Duck (Preschool, 4 years)
...
| Name | Daisy Duck |
| Species | Cute duck |
| Appearance | Soft white feathers, small rounded yellow beak, bright blue eyes, pink cheeks, small fluffy tail feathers, long curved eyelashes, gentle smile inside beak |
| Default Outfit | Purple dress, yellow rain boots, pink bow |
| Style | Pixar-quality, Cocomelon-inspired, bright colorful nursery world, highly detailed, soft lighting, vibrant colors |
| Signature Accessory | Pink bow on head (always present) |
...
|----------|-------------|---------|
| `{name}` | Character name | Daisy Duck |
| `{species}` | Species description | Cute duck |
| `{appearance}` | Physical appearance | Soft white feathers, small rounded yellow beak, ... |
| `{outfit}` | Outfit description | Purple dress, yellow rain boots, pink bow |
| `{outfit_variant}` | Alternate outfit | Purple puffy coat with feather trim |
...
|---|------------|---------------|
| 1 | Neutral | Daisy Duck, Cute duck, soft white feathers, small rounded yellow beak, bright blue eyes, pink cheeks, small fluffy tail feathers, long curved eyelashes, gentle smile inside beak, wearing purple dress, yellow rain boots, pink bow, neutral expression, portrait shot, Pixar-quality, Cocomelon-inspired, bright colorful nursery world, highly detailed, soft lighting, vibrant colors |
...
| # | Outfit | Description |
|---|--------|-------------|
| 1 | Daily Outfit | Purple dress, yellow rain boots, pink bow |
| 2 | Winter Coat | Purple puffy coat with feather trim |
| 3 | Rain Outfit | Yellow raincoat with hood (matches boots) |
| 4 | Swimsuit | Purple and pink one-piece with ruffles |
| 5 | Pajamas | Lavender PJs with music note print |
| 6 | Birthday Outfit | Purple dress with rainbow sash |
| 7 | Ballerina Costume | Purple tutu, ballet slippers |
| 8 | Sports Uniform | Purple athletic wear |
| 9 | Halloween Costume | Swan princess costume |
| 10 | Christmas Outfit | Red and purple dress with snowflakes |
| 11 | Tea Party Outfit | Fancy purple dress with lace trim |
...
|-----|-----------|-------|
| Toddler (2-3) | toddler, smaller body, rounder features, oversized head, 2 years old | Smaller, fluffier, waddles more |
| Preschool (3-4) | preschool age, 4 years old | Current canonical design — graceful dancer |
| Kindergarten (5-6) | kindergarten age, 5-6 years old, slightly taller | Taller, longer feathers, more elegant |
...
## Quality Checklist for Daisy Duck

- [ ] Character is instantly recognizable as Daisy Duck
- [ ] Pink bow on head is visible
- [ ] Blue eyes are bright and expressive
- [ ] Purple dress and yellow rain boots match the signature look
- [ ] Feathers are soft white (not gray or yellow)
- [ ] Beak is small, rounded, and yellow
