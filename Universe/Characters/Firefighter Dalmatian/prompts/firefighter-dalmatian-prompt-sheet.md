# Firefighter Dalmatian — Prompt Reference Sheet

> **Version:** 1.0
> **Character:** Firefighter Dalmatian (Adult)
...
| Species | Dalmatian (white with black spots) |
| Appearance | White fur with distinct black spots across body, big warm brown eyes, floppy black ears, long white tail with black spots, large black nose, friendly alert face, strong athletic sturdy body |
| Default Outfit | Yellow reflective suspenders over tan shirt, red firefighter helmet, black steel-toed work boots |
| Style | Pixar-quality, Cocomelon-inspired, bright colorful nursery world, highly detailed, soft lighting, vibrant colors |
| Signature Accessory | Red firefighter helmet |
...
|----------|-------------|---------|
| `{name}` | Character name | Firefighter Dalmatian |
| `{species}` | Species description | Dalmatian (white with black spots) |
| `{appearance}` | Physical appearance | White fur with distinct black spots, big warm brown eyes, ... |
| `{outfit}` | Outfit description | Yellow reflective suspenders over tan shirt, red helmet |
| `{outfit_variant}` | Alternate outfit | Full yellow reflective turnout gear |
| `{expression}` | Expression name | Happy, Surprised, Sad |
| `{pose}` | Pose name | Standing, Running, Saluting |
...
|---|------------|---------------|
| 1 | Neutral | Firefighter Dalmatian, Dalmatian (white with black spots), white fur with distinct black spots across body, big warm brown eyes, floppy black ears, long white tail with black spots, large black nose, friendly alert face, strong athletic sturdy body, wearing yellow reflective suspenders over tan shirt, red firefighter helmet, black steel-toed work boots, neutral expression, portrait shot, Pixar-quality, Cocomelon-inspired, bright colorful nursery world, highly detailed, soft lighting, vibrant colors |
...
| 16 | Scared | (same base) + scared expression, ears back, portrait shot |
...
| 18 | Saluting | Saluting pose, paw to helmet, full body |
| 19 | Carrying Hose | Carrying fire hose pose, full body |
| 20 | Rescue Carry | Rescue carry pose, full body |
...
| # | Outfit | Description |
|---|--------|-------------|
| 1 | Daily Outfit | Yellow reflective suspenders over tan shirt, red helmet, black boots (signature look) |
| 2 | Turnout Gear | Full yellow reflective coat, black pants, helmet with visor |
| 3 | Casual | Sky blue polo shirt, khaki pants |
| 4 | Winter Outfit | Black insulated jacket, red scarf, warm boots |
| 5 | Rain Outfit | Yellow slicker with reflective stripes |
| 6 | Pajamas | Red PJs with tiny fire hydrant print |
| 7 | Exercise Gear | White tank top, black shorts, gym sneakers |
| 8 | Safety Educator | Orange safety vest, clip-on tie, presentation badge |
| 9 | Parade Uniform | Dress blues with medals, polished badge |
| 10 | Halloween Costume | Dressed as a police officer |
| 11 | Christmas Outfit | Red sweater with dalmatian spots, Santa hat |

---

## Age Variant Prompts

*Skipped — Firefighter Dalmatian is a fixed adult character.*
...
## Quality Checklist for Firefighter Dalmatian

- [ ] Character is instantly recognizable as Firefighter Dalmatian
- [ ] Red firefighter helmet is visible
- [ ] Black spots on white fur are distinct and natural-looking
- [ ] Warm brown eyes are expressive
- [ ] Yellow reflective suspenders match the signature look
- [ ] Spots are dalmatian-like (not too large or small)
- [ ] Proportions are dog-like (not human)
...
- [ ] Background is appropriate and child-friendly (fire station or park)
- [ ] Lighting is soft and warm
- [ ] Style matches Cocomelon-inspired aesthetic
- [ ] Tail is visible and has spots
