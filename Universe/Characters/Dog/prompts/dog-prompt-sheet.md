# Dog — Prompt Reference Sheet

> **Version:** 1.0
> **Character:** Dog (Preschool, 4-5 years)
...
|-----------|-------|
| Name | Dog |
| Species | Cute golden retriever |
| Appearance | Golden yellow fur (lighter on belly), big warm brown eyes, long floppy ears, fluffy always-wagging tail, sturdy athletic build, large black wet-looking nose, wide friendly smile with tongue often out, thick expressive eyebrows |
| Default Outfit | Red collar with golden bone tag (no shirt) |
| Style | Pixar-quality, Cocomelon-inspired, bright colorful nursery world, highly detailed, soft lighting, vibrant colors |
| Signature Features | Floppy ears, wagging tail |
...
| `{species}` | Species description | Cute golden retriever |
| `{appearance}` | Physical appearance | Golden yellow fur, big warm brown eyes, ... |
| `{outfit}` | Outfit description | Red collar with golden bone tag |
| `{outfit_variant}` | Alternate outfit | Red dog coat with fleece lining |
...
| `{age_description}` | Age variant descriptor | Puppy, smaller body, rounder features |
...
|---|------------|---------------|
| 1 | Neutral | Dog, Cute golden retriever, golden yellow fur lighter on belly, big warm brown eyes, long floppy ears, fluffy always-wagging tail, sturdy athletic build, large black wet-looking nose, wide friendly smile with tongue often out, thick expressive eyebrows, wearing red collar with golden bone tag, neutral expression, portrait shot, Pixar-quality, Cocomelon-inspired, bright colorful nursery world, highly detailed, soft lighting, vibrant colors |
...
| # | Outfit | Description |
|---|--------|-------------|
| 1 | Daily Outfit | Red collar with golden bone tag (signature look) |
| 2 | Winter Coat | Red dog coat with fleece lining, matching booties |
| 3 | Rain Outfit | Yellow raincoat with hood, matching booties |
| 4 | Swimsuit | Red swim vest with handle |
| 5 | Pajamas | Red PJs with bone print |
| 6 | Birthday Outfit | Red party hat, "Best Dog" bandana |
| 7 | Sports Uniform | Red athletic vest with number, matching headband |
| 8 | Superhero Costume | Red cape with bone emblem, hero bandana |
| 9 | Firefighter Costume | Red firefighter hat, yellow reflective vest |
| 10 | Halloween Costume | Hot dog costume (ironic and hilarious) |
| 11 | Christmas Outfit | Red and green sweater with bone pattern, antler headband |
...
|-----|-----------|-------|
| Puppy (1-3) | puppy, smaller body, rounder features, oversized paws, 1-3 years old | Smaller, clumsier, even more energy |
| Preschool (4-5) | preschool age, 4-5 years old | Current canonical design — loyal, sporty, full of joy |
| Kindergarten (5-6) | kindergarten age, 5-6 years old, slightly taller | Taller, more disciplined, still energetic |
...
## Quality Checklist for Dog

- [ ] Character is instantly recognizable as Dog
- [ ] Red collar with bone tag is visible
- [ ] Brown eyes are warm and expressive
- [ ] Fur is golden yellow (not orange or brown)
- [ ] Floppy ears are visible
- [ ] Tail looks wagging or ready to wag
